...
class _AddPharmacyState extends State<AddPharmacy> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomeAppBar("Add Pharmacy", true, null),
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        ...
                        left: MediaQuery.of(context).size.width * 0.07,
                        right: MediaQuery.of(context).size.width * 0.07),
                    child: FormFields("Latitude",
                        Icon(Icons.location_on_rounded), null, false, latitude),
                  ),
                  Padding(
                    padding: EdgeInsets.only(
                        top: MediaQuery.of(context).size.height * 0.03,
              ...
              child: CustomButton(
                  "Submit",yellow, Colors.white,
                    ...
                    if (formKey.currentState != null &&
                       ...
                       String output = await CloudFirestoreClass().uploadPharmacyToDatabase(
                           image: image, Name: name.text, long: longitude.text, lat: latitude.text,);
